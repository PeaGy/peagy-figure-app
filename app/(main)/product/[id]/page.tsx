            ...
            <div className="mt-7 rounded-2xl border border-[#e9e4df] bg-white p-4 shadow-[0_10px_30px_rgba(55,45,39,0.05)] sm:p-5">
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  ...
                  className="flex h-12 flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-xl bg-[#FBBBB9] px-5 text-[14px] font-semibold text-white shadow-lg shadow-pink-900/10"
                >
